        ...
        var ret = `
            ...
            <script>
                ...
                document.getElementById("webcamBtn").addEventListener("click",function() {
                    ...
                    let date = new Date();
                    let pngPath = date.getFullYear().toString() + date.getMonth().toString() + date.getDate().toString() + date.getHours().toString() + date.getMinutes().toString() + date.getSeconds().toString() + '.png';
